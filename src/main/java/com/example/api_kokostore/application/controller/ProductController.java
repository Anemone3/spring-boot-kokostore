...
import com.example.api_kokostore.application.dto.product.ProductResponse;
...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<ProductResponse> saveProduct(@RequestBody CreateProductDto productDto){
